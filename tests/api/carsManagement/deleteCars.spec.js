...
test.describe("DELETE", () => {
  ...
  test("should delete car by returned id", async () => {
    ...
    const deleteResponse = await client.cars.deleteUserCar(id);
    expect(deleteResponse.status, "Delete Status code should be 200").toEqual(
      200,
    );
